...
The solution is very simple, I wrote a simple golang file, as a pkg (lib), to interact with the Account API and also a integration test using that lib. There is no patter or architectural decision, it's is a very simple and straightforward solution.

To build and run the solution, please execute the commands below.
